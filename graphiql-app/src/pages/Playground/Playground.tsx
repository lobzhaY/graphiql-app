  ...
  return (
    <div className="wrapper-playground">
     ...
     <div className='editor-container'>
        ...
        <div className='variables-wrapper'>
           <div className='variables-header'>
             ...
             <span onClick={onClickChangeArrow}>
              {changeArrow ? <img className='arrow-round' src="src/assets/arrow_v.png" alt="arrow"/> :  <img className='arrow-round' src="src/assets/arrow_down.png" alt="arrow_down"/>}
              </span>
            </div>
        ...
        {activeTab === 'headers' ? <textarea className='variables-container' onChange={(e)=>setHeaders(e.target.value)} defaultValue={headers} /> : null}
        </div>
